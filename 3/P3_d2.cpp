...
/*
Misma plantilla del inciso C. La perturbación
consiste en un desplazamiento en X cercano a una
milésima de la distancia Sol - Júpiter.
*/
...
void gnuplot_output(){
  ...
  std::cout << "set output 'P3_d.pdf'" << std::endl;
  std::cout << "set size ratio -1" << std::endl;
  std::cout << "plot \"P3_d.dat\" u 5:6 w l t 'Trojano'" << std::endl;
}
