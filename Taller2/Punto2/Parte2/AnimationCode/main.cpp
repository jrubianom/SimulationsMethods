...
class LatticeBoltzmann{
  ...
  public:
    ...
    void Advection(void);
    void Print(string NombreArchivo);
...
void LatticeBoltzmann::Print(string  NameFile){
...
void InicieAnimacion(ofstream &file){
  ...
  file<<"set output 'Mirror.gif'"<<endl;
  file<<"unset key"<<endl;
  file<<"set xrange[0:"<<Lx<<"]"<<endl;
  file<<"set yrange[0:"<<Ly<<"]"<<endl;
